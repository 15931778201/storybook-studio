...
import StepPipelineView from '../components/StepPipelineView';
...
export default function ChatPage() {
  ...
  // ==================== 确认弹窗逻辑（原 ChatPage） ====================
  const { confirmRequest, handleConfirm, handleReject } = useConfirm();

  // ==================== 渲染 ====================
  return (
    <>
      {/* 聊天界面部分（原 ChatLayout 的 JSX） */}
      ...
      {/* 工具确认弹窗（原 ChatPage 的 ConfirmDialog） */}
      {confirmRequest && (
        <ConfirmDialog
